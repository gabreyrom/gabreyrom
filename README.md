...
- **🌍 FIFA World Cup 2026 Match Predictor** — Predictive modeling for match outcomes of the tournament (in progress).
- **⚽ La Liga Shot Analysis (2017/18)** — End-to-end statistical modeling and inference on soccer shot event data.
- **🚦 Traffic Optimization via Collective Intelligence** — Applying collective intelligence frameworks to urban traffic flow.

---

## Academic Background

- **M.S. Data Science** — Stevens Institute of Technology *(2025–2026)*
- **B.S. Mechatronics Engineering & B.S. Industrial Engineering** — Instituto Tecnológico Autónomo de México *(2014-2019)*
